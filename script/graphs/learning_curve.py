...
def generate_graph(stats, outputfile: str):
    ...
    axs[1].plot(x, [stats[i]["train-tn"] for i in x], label="train tn", linewidth=1)
    axs[1].plot(x, [stats[i]["train-f1"] for i in x], label="train f1", linewidth=1)
    axs[1].plot(x, [stats[i]["train-precision"] for i in x], label="train precision", linewidth=1)
    axs[1].plot(x, [stats[i]["train-recall"] for i in x], label="train recall", linewidth=1)
    axs[1].grid()
    axs[1].legend()
    ...
    axs[2].plot(x, [stats[i]["test-tn"] for i in x], label="test tn", linewidth=1)
