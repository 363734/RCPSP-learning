...
if __name__ == "__main__":
    ...
    inst = parse_rcpsp("./datas/psplib/j90/j906_3.sm", PSPLIB)
    log_trivial_precedences(inst,"./datas_preprocessed/psplib/j90/j906_3_trivial_prec.txt")
    print_additional("./results/proofofconcept/j906_3/additionnal_prec_j906_3_{}percent_{}.txt", inst,
                     filter_precedence(inst, parse_precedence(
                         "./datas_preprocessed/j90/j906_3_all_prec_optimal_solution.txt")))
